...
import com.manyi.business.pay.common.RequestService;
...
/**
 * @author ZhangYuFeng on 2015/6/10 0010,9:57.
 * @Description:
 * @reviewer:
 */
@Service("dealCheckFileService")
public class CheckServiceImpl implements CheckService {
    ...
    public String getCheckFileUrl() {
        String reqParam = DealParamStr.buildGetCheckFileUrl();
        String respString = requestService.doPostRequest(properties.getProperty("request_url"), reqParam,null);
        Map<String, String> respMap = DealParamStr.analyzeRespStr(respString);
        String fileUrl = respMap.get(ParamKey.DOWNLOAD_URL.getParamKey());
        return fileUrl;
    }
